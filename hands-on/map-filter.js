...

{
    ...
    function convertFrench() {
        ...
        for (let i = 0; i < frenchCommands.length; i++) {
            frenchArr.push(frToEn[frenchCommands[i]]);
            // switch (frenchCommands[i]) {
            //     case 'à gauche':
            //         frenchArr.push('TURN-LEFT');
            //         break;
            //     case 'marche':
            //         frenchArr.push('MOVE');
            //         break;
            //     case 'à droit':
            //         frenchArr.push('TURN-RIGHT');
            //         break;
            //     default: console.log('error !', frenchCommands[i]);
