...

{
    ...
    function convertEnglish(commands) {
        // Add your code here
        for (let j = 0; j < englishCommands.length; j++){
            englishCommands[j]= englishCommands[j].toUpperCase();
        }
    }
    convertEnglish();
    /**
     ...
     */
    function convertFrench(frenchCommands) {
        ...
        switch (frenchCommands) {
            ...
            case 'marche':
                ...
                break;
            case 'a droit':
                frenchArr.push('RIGHT');
                break;
            default: console.log('error !');
        }
    }
    convertFrench('marche');
